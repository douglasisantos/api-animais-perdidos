...
# def listar_animais_perdidos(request):
#     # Recupere todos os animais perdidos do banco de dados
#     animais_perdidos = AnimalPerdido.objects.all()
#     # Renderize o template HTML e passe os animais perdidos como contexto
#     return render(request, 'listar_animais_perdidos.html', {'animais_perdidos': animais_perdidos})
